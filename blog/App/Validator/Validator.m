...
+ (BOOL) isValidCreditNumber:(NSString*)value
{
    ...
    if (length >= 13)
    {
        result = [Validator isValidNumber:value];
        if (result)
        {
...
+ (BOOL) isValid:(IdentifierType) type value:(NSString*) value
{
    ...
    switch (type)
    {
        case IdentifierTypeZipCode:
            result = [Validator isValidZipcode:value];
            break;
        ...
        case IdentifierTypePhone:
            result = [Validator isValidPhone:value];
            break;
        case IdentifierTypeUnicomPhone:
            result = [Validator isChinaUnicomPhoneNumber:value];
            break;
        ...
        case IdentifierTypeString:
            result = [Validator isValidString:value];
            break;
        case IdentifierTypeIdentifier:
            result = [Validator isValidIdentifier:value];
            break;
        case IdentifierTypePassort:
            result = [Validator isValidPassport:value];
            break;
        case IdentifierTypeCreditNumber:
            result = [Validator isValidCreditNumber:value];
            break;
        case IdentifierTypeBirthday:
            result = [Validator isValidBirthday:value];
            break;
        default:
            break;
    }
